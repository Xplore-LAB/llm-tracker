(()=>{
  ...
  const GUIDES={
    ...
    lab:{title:'实验路径',desc:'从容量和速度估算进入，再用采样、优化与注意力实验验证原理。',items:[['显存估算',ROOT+'hardware/?chapter=calc','先做资源判断'],['推理部署',ROOT+'deploy/?section=serving','理解性能指标'],['术语馆',ROOT+'glossary/','补齐实验概念'],['模型技术档案',ROOT+'models/','回看具体实现']]}
  };
