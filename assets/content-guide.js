(()=>{
  ...
  const GUIDES={
    ...
    leaderboard:{title:'模型选型判断路径',desc:'先分清两个榜衡量什么，再按能力、成本、开放度三条线收窄候选，最后落到部署可行性。',items:[['能力榜排序',ROOT+'leaderboard/','AA Index 同一口径独立跑测，看真实能力高低'],['偏好榜排序',ROOT+'leaderboard/','Arena Elo 人类盲测，看实际使用观感'],['开放权重筛选',ROOT+'leaderboard/','锁定可自部署的模型，注意许可协议陷阱'],['雷达图对比',ROOT+'leaderboard/','勾选 2 至 4 个模型，五维横向看取舍'],['接部署链路',ROOT+'deploy/','选定后进入框架、量化与服务化实践']]},
